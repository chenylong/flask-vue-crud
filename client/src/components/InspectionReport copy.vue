        ...
        <section class="bg-white p-6 rounded-lg shadow-md w-full max-w-3xl">
          ...
          <table class="w-full mt-4">
            ...
            <tbody>
              ...
              <tr>
                <td class="py-2 px-4">车牌号</td>
                <td class="py-2 px-4">{{ plateNumber || '未提供' }}</td>
              </tr>
              <tr>
                <td class="py-2 px-4">车辆所有人</td>
                <td class="py-2 px-4">{{ vehicleOwner || '未提供' }}</td>
              </tr>
              <tr>
                <td class="py-2 px-4">驾驶人</td>
                <td class="py-2 px-4">{{ driver || '未提供' }}</td>
              </tr>
              <tr>
                <td class="py-2 px-4">驾驶证号</td>
                <td class="py-2 px-4">{{ driverLicense || '未提供' }}</td>
              </tr>
              <tr>
                <td class="py-2 px-4">是否有违法所得</td>
                <td class="py-2 px-4">{{ hasLicense === '否' ? '是' : '否' }}</td>
              </tr>
              <tr>
                <td class="py-2 px-4">违法所得金额</td>
                <td class="py-2 px-4">{{ hasLicense === '否' ? '322元' : '未提供' }}</td>
              </tr>
              <tr class="bg-blue-500 text-white">
                <th class="py-2 px-4" colspan="2">被检查人意见</th>
              </tr>
              <tr>
                <td class="py-2 px-4">对以上检查情况有无异议？</td>
                <td class="py-2 px-4">{{ inspectionOpinion || '无异议' }}</td>
              </tr>
              <tr class="bg-blue-500 text-white">
                <th class="py-2 px-4" colspan="2">检查人员信息</th>
              </tr>
              <tr>
                <td class="py-2 px-4">检查人员1</td>
                <td class="py-2 px-4">{{ inspector1Name }}</td>
              </tr>
              <tr>
                <td class="py-2 px-4">执法证号1</td>
                <td class="py-2 px-4">{{ inspector1Id }}</td>
              </tr>
              <tr>
                <td class="py-2 px-4">检查人员2</td>
                <td class="py-2 px-4">{{ inspector2Name }}</td>
              </tr>
              <tr>
                <td class="py-2 px-4">执法证号2</td>
                <td class="py-2 px-4">{{ inspector2Id }}</td>
              </tr>
            </tbody>
          </table>
        </section>
