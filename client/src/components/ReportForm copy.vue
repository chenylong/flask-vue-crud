<template>
  <div class="min-h-screen bg-gray-100">
    ...
    <el-collapse v-model="activeCollapse">
        ...
        <ul v-if="relatedInfo.length" class="list-disc list-inside text-gray-700">
          <li v-for="(item, index) in relatedInfo" 
              ...
              :class="[
                ...
                selectedItems.includes(item) ? 'bg-green-100 text-green-800' : 'hover:bg-gray-100'
              ]"
      ...
      <el-button type="primary" @click="submitForm2" class="w-full py-2 text-lg font-semibold">提交</el-button>
    </main>
  ...
  <style>
  @import 'https://cdnjs.cloudflare.com/ajax/libs/tinymce/5.10.0/skins/ui/oxide/skin.min.css';
  </style>